...
const TABS: { key: TabType; label: string; icon: React.ElementType; emptyText: string; emptyHint: string; actionLabel?: string; actionPath?: string }[] = [
  { key: "prayer",      label: "Prayers",      icon: HandIcon,   emptyText: "Some prayers are meant to be remembered.",     emptyHint: "This is where they'll stay.",                                                                                         actionLabel: "Open today's devotional",  actionPath: "/devotional" },
