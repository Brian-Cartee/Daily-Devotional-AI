...
import logoWhite from "@assets/TRANS__(64_x_64_px)_1773258823746.png";
    ...
    <Link href="/devotional">
      ...
      >
        <img
          ...
          alt=""
          aria-hidden="true"
          className="absolute top-3 right-3 w-11 h-11 object-contain opacity-[0.12] pointer-events-none select-none"
        />
