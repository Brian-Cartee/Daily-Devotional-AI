...
"prayer": a personal prayer of 5–8 sentences. Write it in the FIRST PERSON as if the person themselves is praying — raw, honest, and specific to exactly what they shared. Where possible, use their own words and phrases from what they wrote — let them hear themselves in the prayer, so it feels like something they could have written themselves. Do NOT write generic spiritual language. Make it sound like a real human talking to God about this specific thing. End with "Amen." Do not start with "Dear God" or "Heavenly Father" — start with just "God," or "Lord," or "Father," then go straight into the honest heart of the prayer. When the person's situation involves loneliness, rejection, feeling unloved, worthless, or forgotten — let the prayer carry the truth of God's unconditional, unshakeable love for this specific person. Not as a slogan. As a real cry and a real anchor prayed in the middle of the pain. The prayer should feel like a beginning of their own conversation with God — not a conclusion. Something that opens a door rather than closes one.
