...
const group2 = [
  ...
  { label: "Explore Scripture",    desc: "A question, a passage, anything on your mind", color: "text-amber-400", bg: "border-amber-500/25 bg-amber-500/8", Icon: Sparkles },
];
  ...
  return (
    <div className="grid grid-cols-2 gap-2.5">
      {tiles.map(({ label, desc, color, bg, Icon }) => (
        <div
          key={label}
          className={`rounded-2xl border p-4 flex flex-col gap-2 cursor-pointer hover:opacity-90 active:scale-[0.98] transition-all ${bg}`}
        >
  ...
  return (
    <div className="min-h-screen bg-[#0d0a1a] flex flex-col items-center justify-start p-4 pt-8">
      <div className="w-full max-w-[358px] flex flex-col gap-5">
        ...
        {/* Thin divider */}
        <div className="h-px bg-white/6 mx-2 -mt-2" />
