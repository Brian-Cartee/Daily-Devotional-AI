  ...
  return (
    <Link href="/prayer-closet">
      ...
      >
        ...
        {/* Doorway — crop toward the doors, not the floor cushions */}
        <img
          src={CLOSET_DOORWAY_SRC}
          alt=""
          className="absolute inset-0 w-full h-[115%] object-cover object-[center_22%] scale-[1.06] group-hover:scale-[1.08] transition-transform duration-500"
        />
