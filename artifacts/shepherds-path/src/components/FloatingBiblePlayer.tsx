...
export function FloatingBiblePlayer({
  book,
  chapter,
  listenText,
  canPrev,
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        data-testid="floating-bible-player"
      >
          ...
          <div className="px-3 pt-2 pb-2.5">
            ...
            <div className="flex items-center justify-center gap-5">
              <button
                ...
                data-testid="floating-bible-prev"
              ...
              <button
                ...
                data-testid="floating-bible-play"
              ...
              <button
                ...
                data-testid="floating-bible-next"
                className="w-10 h-10 rounded-full flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted/60 disabled:opacity-30 transition-colors shrink-0"
              >
