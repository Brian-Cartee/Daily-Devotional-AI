...
export function ClosetPrayerRug() {
  return (
    <div
    ...
    >
      <svg
        viewBox="0 0 148 200"
        className="w-full h-full drop-shadow-[0_12px_28px_rgba(0,0,0,0.55)]"
        role="img"
        aria-label=""
      >
        <defs>
          ...
          <linearGradient id="rug-gold" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#fcd34d" />
            <stop offset="100%" stopColor="#d97706" />
          </linearGradient>
          <linearGradient id="rug-violet" x1="50%" y1="0%" x2="50%" y2="100%">
            <stop offset="0%" stopColor="#8b5cf6" stopOpacity="0.35" />
            <stop offset="100%" stopColor="#4c1d95" stopOpacity="0.15" />
          </linearGradient>
          <pattern id="rug-diamond" width="12" height="12" patternUnits="userSpaceOnUse">
            <path
        ...
        {/* Diamond field */}
        <rect x="28" y="82" width="92" height="88" fill="url(#rug-diamond)" opacity="0.9" />

        {/* Center medallion */}
        <circle cx="74" cy="118" r="22" fill="none" stroke="url(#rug-gold)" strokeWidth="1.2" opacity="0.85" />
